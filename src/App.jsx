...
function App() {
  ...
  const backgroundPicture =
    "https://cdn.pixabay.com/photo/2024/09/17/01/32/forest-9052633_1280.jpg";
  ...
  return (
    <>
      <section
        className="w-full min-h-screen flex flex-wrap justify-center flex-col items-center space-y-2 bg-no-repeat bg-cover"
        style={{
          backgroundImage: `url(${backgroundPicture})`,
        }}
      >
        <h1 className="px-4 py-5 mb-2 rounded-lg bg-gray-200/80 text-2xl font-semibold sm:text-5xl dark:bg-gray-500/60 dark:text-gray-50 text-center">
          Welcome To Know Movie Infomation Website.
        </h1>
